...
class PNGQuant
{
    ...
    public function setBinaryPath($pathToBinary)
    {
        $this->_binaryPath = escapeshellarg($pathToBinary);
        return $this;
    }

    public function setOption($key, $value = null, $space = false, $isPath = false)
    {
    ...
    public function buildCommand()
    {
        ...
        foreach ($this->_options as $option) {
            ...
            if ($space) $_command .= " $key $value";
            else $_command .= " $key=$value";
        }
    ...
    public function disableDithering()
    {
    ...
    public function setDitheringLevel($level)
    {
        return $this->setOption('--floyd', $level);
    }

    public function skipIfLarger()
    {
        return $this->setOption('--skip-if-larger');
    }

    public function setQuality($min_quality = 60, $max_quality = 80)
    {
        return $this->setOption('--quality', "$min_quality-$max_quality", true);
    }

    public function setOutputImage($imagePath)
    {
    ...
    public function overwriteExistingFile()
    {
        return $this->setOption('--force');
    }

    public function posterize($value)
    {
